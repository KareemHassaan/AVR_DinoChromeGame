...
#define LCD_CursorDisplay    			0x00				//PIN1 --> (0) for Cursor Display  OFF & (1) for Cursor Display  ON.
#define LCD_CursorBlinking   			0x00				//PIN0 --> (0) for Cursor Blinking OFF & (1) for Cursor Blinking ON.
